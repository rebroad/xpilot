/* $Id: query.cpp,v 1.9 2004/02/03 03:39:52 dick Exp $
 *
 ...
 *
 * Revision 1.7  2001/08/08 00:37:17  dick
 * usleep becomes microdelay.
 *
 * Revision 1.6  2001/08/07 22:14:22  dick
 * usleep becomes microdelay.
 *
 * Revision 1.5  2001/08/07 21:00:37  dick
 * micro_delay becomes usleep
 *
 * Revision 1.4  2001/08/06 06:00:46  dick
 ...
 */
static int Query_subnet(Sock* sock,
...
static int Query_fudged(Sock* sock, int port, char *msg, int msglen)
{
    int			i, count = 0;
    unsigned char	*p;
...
int Query_all(Sock* sock, int port, char *msg, int msglen)
{
#ifdef QUERY_FUDGED
