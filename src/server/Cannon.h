/* $Id: Cannon.h,v 1.4 2002/06/01 06:06:48 dick Exp $
 *
...
//#define CANNON_SHOT_SPEED	theWorld.options.shotSpeed->GetDouble()
...
public:
	...
	void	Aim(int weapon, int* target, int* targetDir);
	void	ThrowItems();
	void	CheckDefense();
	void	CheckFire();
...
private:
	...
	int		SelectWeapon();
	void	Fire(int weapon, int target, int targetDir);
	int		InDanger();
