/* $Id: ScoreEngineBasicXMLCfg.cpp,v 1.3 2004/02/03 03:39:53 dick Exp $
 *
 ...
 */
/*
 * $Log: ScoreEngineBasicXMLCfg.cpp,v $
...
#define	xarOBJECT	ScoreEngineBasicXMLCfg
xarDECLARES;
xarDeclareToken(ScoreEngineBasicXMLCfg);
xarDeclareToken(flushDelay);

///////////////////////////////////////////////////////////////////////////////
ScoreEngineBasicXMLCfg::ScoreEngineBasicXMLCfg()
{
	flushDelay = (60*10);		// every 10 minutes
}

///////////////////////////////////////////////////////////////////////////////
void ScoreEngineBasicXMLCfg::XMLStartHandler(void *data, const char *el, const char **attr)
{
	ScoreServer* d = (ScoreServer*)data;
	TRACEXMLSTART(ScoreEngineDefBasicXML);

#define	xarObjPREFIX	(*(ScoreEngineBasicXMLCfg*)(d->selector.Find(ScoreEngineBasicXML::name)))
	xarParseInt(flushDelay);
}

///////////////////////////////////////////////////////////////////////////////
void ScoreEngineBasicXMLCfg::XMLEndHandler(void *data, const char *el)
{
	ScoreServer* d = (ScoreServer*)data;
	TRACEXMLEND(ScoreEngineBasicXMLCfg);

	xarParseObjectEnd(ScoreEngineBasicXMLCfg);
}

///////////////////////////////////////////////////////////////////////////////
void ScoreEngineBasicXMLCfg::XMLOutVirtual(XMLArchive& xar)
{
	xar.WriteElementStart(ScoreEngineBasicXMLCfg);
	xar.WriteIntAttr(flushDelay);
	xar.WriteElementEnd(ScoreEngineBasicXMLCfg);
}
