/* $Id: ScoreEngineBasicXMLCfg.h,v 1.1 2004/01/30 16:02:49 dick Exp $
 *
 * XPScoreServer - Who's on first?
 * ScoreEngineBasicXMLCfg - Config for the Basic XML Score Engine
 *
 *      Copyright (C) 2004 by
 *
 ...
 */
/*
 * $Log: ScoreEngineBasicXMLCfg.h,v $
...
#ifndef	_SCOREENGINEBASICXMLCFG_H_
#define	_SCOREENGINEBASICXMLCFG_H_

#include "ScoreEngineBasicCfg.h"

#define	ScoreEngineBasicXMLCfgSUPERCLASS	ScoreEngineBasicCfg
class ScoreEngineBasicXMLCfg : public ScoreEngineBasicXMLCfgSUPERCLASS
{
public:
	ScoreEngineBasicXMLCfg();
