...
#ifndef XPFileChooser_h
#define XPFileChooser_h
#include <FL/Fl.H>
...
class FL_EXPORT XPFileChooser {
public:
  enum { SINGLE = 0, MULTI = 1, CREATE = 2, DIRECTORY = 4 };
private:
  static Fl_Preferences prefs_;
  void (*callback_)(XPFileChooser*, void *);
  void *data_;
  ...
  void fileNameCB();
  void newdir();
  static void previewCB(XPFileChooser *fc);
  void showChoiceCB();
  void update_favorites();
  void update_preview();
public:
  XPFileChooser(const char *d, const char *p, int t, const char *title);
private:
...
public:
  Fl_Check_Button *wildMapButton;
private:
  inline void cb_wildMapButton_i(Fl_Check_Button*, void*);
  static void cb_wildMapButton(Fl_Check_Button*, void*);
public:
  Fl_Box *mapInfo;
private:
...
public:
  Fl_Box *wildLabel;
  Fl_Value_Input *wildNumber;
private:
  inline void cb_wildNumber_i(Fl_Value_Input*, void*);
  static void cb_wildNumber(Fl_Value_Input*, void*);
public:
  Fl_Button *wildRandomButton;
private:
  inline void cb_wildRandomButton_i(Fl_Button*, void*);
  static void cb_wildRandomButton(Fl_Button*, void*);
public:
  Fl_Slider *wildSlider;
private:
  inline void cb_wildSlider_i(Fl_Slider*, void*);
  static void cb_wildSlider(Fl_Slider*, void*);
...
public:
  ~XPFileChooser();
  void callback(void (*cb)(XPFileChooser *, void *), void *d = 0);
...
private:
  static const char* wildMap_label;
  int wildMap(int e);
  void wildNumberCB();
  void wildRandomCB();
  void wildSliderCB();
...
FL_EXPORT void XPFileChooser_callback(void (*cb)(const char*));
#endif
